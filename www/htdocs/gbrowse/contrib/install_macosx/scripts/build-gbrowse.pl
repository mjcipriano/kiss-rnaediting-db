...
END
  ...
  # echo perl -p -i -e 's|\/Users\/todd\/projects\/macosx\/gbrowse\/gbrowse\/files||g' /svr/www/cgi-bin/gbrowse
  # perl -p -i -e 's|\/Users\/todd\/projects\/macosx\/gbrowse\/gbrowse\/files||g' /svr/www/cgi-bin/gbrowse
