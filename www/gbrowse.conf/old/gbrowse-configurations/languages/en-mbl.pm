...
Search using a keyword, sequence read, contig, supercontig, GenBank/SwissProt accession number, ORF ID (orf:16670), SAGE ID (sagetag:465), tRNA (trna:Leu), or other landmark%s.
END
...
END
   ...
   DUMPS       => 'Downloads and Advanced Tools',
